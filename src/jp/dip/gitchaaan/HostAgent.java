 ...
 * <code><pre>
 *     java jade.Boot -gui host:jp.dip.gitchaaan.HostAgent()
 * </pre></code>
 * </p>
 *
 * @author Ian Dickinson, HP Labs (<a href="mailto:Ian_Dickinson@hp.com">email</a>)
 * @version CVS info: $Id: jp.dip.gitchaaan.HostAgent.java 5373 2004-09-22 13:07:26Z dominic $
 */
    ...
    extends Agent
{
    ...
    protected void setup() {
        try {
            ...
            System.out.println( "Saw exception in jp.dip.gitchaaan.HostAgent: " + e );
            e.printStackTrace();
        }
	...
	PlatformController container = getContainerController(); // get a container controller for creating new agents
		...
		AgentController guest = container.createNewAgent(localName, "jp.dip.gitchaaan.GuestAgent", null);
		guest.start();
                //Agent guest = new jp.dip.gitchaaan.GuestAgent();
